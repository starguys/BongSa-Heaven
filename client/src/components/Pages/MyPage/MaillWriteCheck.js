...
export default function MaillWriteCheck() {
  ...
  const SendBtnYes = styled.button`
  ...
  return (
    <>
      ...
      <SendTextContainer> 쪽지를 전송하시겠습니까?</SendTextContainer>
      <SendBtnContainer>
        <SendBtnYes>회원탈퇴</SendBtnYes>
        <SendBtnNo>취소</SendBtnNo>
      </SendBtnContainer>
    </>
  );
}
